...
export default function ManageStudents() {
  ...
  useEffect(() => {
  fetch("https://online-course-registration-system.onrender.com/admin/students")
    .then(res => res.json())
    .then(data => {
    ...
    const res = await fetch(`https://online-course-registration-system.onrender.com/admin/students/${student.student_id}/courses`);
