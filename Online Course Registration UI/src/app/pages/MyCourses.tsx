...
const fetchMyCourses = async () => {
  const response = await fetch(`https://online-course-registration-system.onrender.com/my-courses/${studentId}`);
...
useEffect(() => {
  ...
  try {
    await fetch("https://online-course-registration-system.onrender.com/enroll", {
      method: "DELETE",
      headers: {
